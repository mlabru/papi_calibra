...
def detect(fimg_ptr):
    ...
    r_circles = cv2.HoughCircles(limg_mask_r, cv2.HOUGH_GRADIENT, 1, 60, param1=50, param2=5,  minRadius=0, maxRadius=10)
    g_circles = cv2.HoughCircles(limg_mask_g, cv2.HOUGH_GRADIENT, 1, 60, param1=50, param2=10, minRadius=0, maxRadius=30)

    # achou círculos vermelhos ?
    if r_circles is not None:
        l_bitmap, limg_mask_r = __search(limg_ptr, lt_size, limg_mask_r, r_circles[0, :], 0.3, "VRM")
