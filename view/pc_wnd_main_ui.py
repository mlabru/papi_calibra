...
class Ui_wndMain(object):
    def setupUi(self, wndMain):
        ...
        self.qtw_sensors = QtGui.QTabWidget(self.centralwidget)
        self.qtw_sensors.setObjectName(_fromUtf8("qtw_sensors"))
        self.tab_sns = QtGui.QWidget()
        self.tab_sns.setObjectName(_fromUtf8("tab_sns"))
        self.qtw_sensors.addTab(self.tab_sns, _fromUtf8(""))
        self.tab_mon = QtGui.QWidget()
        self.tab_mon.setObjectName(_fromUtf8("tab_mon"))
        self.qtw_sensors.addTab(self.tab_mon, _fromUtf8(""))
        self.tab_cal = QtGui.QWidget()
        self.tab_cal.setObjectName(_fromUtf8("tab_cal"))
        self.qtw_sensors.addTab(self.tab_cal, _fromUtf8(""))
        self.verticalLayout_4.addWidget(self.qtw_sensors)
        ...
        self.qtw_sensors.setCurrentIndex(0)
    ...
    def retranslateUi(self, wndMain):
        ...
        self.qtw_sensors.setTabText(self.qtw_sensors.indexOf(self.tab_sns), _translate("wndMain", "Sensores", None))
        self.qtw_sensors.setTabText(self.qtw_sensors.indexOf(self.tab_mon), _translate("wndMain", "Monitor", None))
        self.qtw_sensors.setTabText(self.qtw_sensors.indexOf(self.tab_cal), _translate("wndMain", "Calibração", None))
