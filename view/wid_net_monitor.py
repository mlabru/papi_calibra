...
# view
import view.wid_net_monitor_ui as nmui
...
class CWidgetNetMonitor(QtGui.QWidget, nmui.Ui_widMon):
    """
    ...
    def __init__(self, f_parent):
        ...
        # setup
        self.gbx_cam.setStyleSheet(gdefs.D_GBX_STYLE)
        self.gbx_sns.setStyleSheet(gdefs.D_GBX_STYLE)
    ...
    def __on_msg_camera(self, fs_msg):
        ...
        self.pte_camera.appendPlainText(fs_msg)
    ...
    def __on_msg_ccc(self, fs_msg):
        ...
        """    
        # put text on textEditor
        self.pte_ccc.appendPlainText(fs_msg)
    ...
    def __on_msg_sensor(self, fs_msg):
        ...
        """    
        # put text on textEditor
        self.pte_sensor.appendPlainText(fs_msg)
    '''
    # ---------------------------------------------------------------------------------------------
